...
export HEARTH_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-hearth
export APPLICATION_CONFIG_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-application-config
export OPENHIM_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-openhim
export PERFORMANCE_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-performance
export USER_MGNT_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-user-mgnt
export METRICS_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-metrics
export WEBHOOKS_MONGO_URL=$MONGODB_ADDRESS/$DATABASE_PREFIX-webhooks
